...
export const useAuth = (): AuthContextValue => {
  ...
  if (!ctx) {
    // #region agent log
    fetch('http://127.0.0.1:7723/ingest/3e757b8c-e55b-48a6-b819-71791092e113',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'432427'},body:JSON.stringify({sessionId:'432427',runId:'run1',hypothesisId:'H3',location:'src/auth/useAuth.ts:10',message:'useAuth missing provider',data:{},timestamp:432427})}).catch(()=>{})
    // #endregion
